...
extern const u8 gText_Birch_Welcome_Custom[];
extern const u8 gText_Birch_Welcome_Choose_Gender_Custom[];
extern const u8 gText_Birch_Welcome_Choose_Name_Custom[];
extern const u8 gText_Birch_SoItsPlayer_Custom[];
