...
const u32 gTrainerFrontPic_Brock[] = INCBIN_U32("graphics/trainers/front_pics/firered/brock.4bpp.lz");
const u16 gTrainerPalette_Brock[] = INCBIN_U16("graphics/trainers/front_pics/firered/brock.gbapal");
// Firered import end
